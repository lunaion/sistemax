...
@section('title','Detalles de ciudades')
@section('styles')
        ...
        <div class="col-12">
            <div class="card">
                            ...
                            <div class="profile-feed">
                                <div class="d-flex align-items-start profile-feed-item">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <hr>
                                        <strong><i class="fas fa-address-card mr-1"></i> Comentario</strong>
                                        <p class="text-muted">
                                            {{$city->comment}}
                                        </p>
                                        <hr>
                ...
                <div class="card-footer text-muted">
                    <a href="{{route('cities.index')}}" class="btn btn-primary float-right">Regresar</a>
                </div>
            </div>
        </div>
    </div>
