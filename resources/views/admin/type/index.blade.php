...
@section('title','Gestión de tipos')
@section('styles')
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{route('types.create')}}" type="button" class="btn btn-info ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 50px;">
                                        ...
                                        <a class="jsgrid-button jsgrid-edit-button" href="{{ route('types.edit', $type) }}" title="Editar">
